...
var lx = {
    ...
    ,login:function(data){
        ...
        if (!that.login_open){
            ...
            <input type="text" id="layui-layer-content_code" class="layui-layer-input" placeholder="验证码"
                style="margin-top: 6px;background:url('${lx.wwwroot+"/login/code"}') no-repeat scroll right center transparent;">
            <button type="button" class="layui-btn layui-btn-fluid" onclick="changeCode()" style="margin-top: 6px;">换一个验证码</button>
            <script>
                function changeCode() {
