package com.lx.core.aop.代理.代理框架;//说明:
...
//        new LogProxy().newInstance(ProxyFactory.class).say("参数1");
    }

    @Proxy(before_class = AA.class ,before_method ="before" ,before_method_para = false,after_class = AA.class,after_method = "after",after_method_para = false)
